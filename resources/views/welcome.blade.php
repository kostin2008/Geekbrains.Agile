           ...
           <div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center py-4 sm:pt-0">
            @if (Route::has('login'))
                <div class="hidden fixed top-0 right-0 px-6 py-4 sm:block">
                    @auth
                            ...
                            <a href="{{route('myPlants.index')}}" class="text-sm text-gray-700 underline">Личный кабинет</a>
            ...
            <div class="row justify-content-center max-w-6xl mx-auto sm:px-6 lg:px-8">
               <div class="col-4 text-center">
                <h1>Приветствуем на сайте ухода за растениями!</h1>
                <p>Чтобы добавить растение в избранное и посмотреть календарь ухода, пожалуйста, зарегистрируйтесь</p>
               </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2">
                        <div class="p-6">
                            <div class="flex items-center">
                                ...
                                <path d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 
                                ...
                                <a href="{{route('catalog')}}">Категории растений</a>
                                </div>
